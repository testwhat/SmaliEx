...
public class ImmutableInstruction45cc extends ImmutableInstruction implements Instruction45cc {
    ...
    public ImmutableInstruction45cc(@Nonnull Opcode opcode,
        ...
        this.reference2 = ImmutableReferenceFactory.of(opcode.referenceType2, reference2);
    }
    ...
    @Nonnull @Override public ImmutableReference getReference2() { return reference2; }
